...
use crate::{
    ...
    utils::{
        ...
        verify_readonly_or_writable_alias, verify_signer, verify_token_account_owner, verify_token_program,
        verify_writable,
    },
};
...
impl<'a> TryFrom<&'a mut [AccountView]> for RevokeDirectRecipientAccounts<'a> {
    ...
    fn try_from(accounts: &'a mut [AccountView]) -> Result<Self, Self::Error> {
        ...
        verify_readonly_or_writable_alias(recipient, &[original_payer])?;
...
impl<'a> InstructionAccounts<'a> for RevokeDirectRecipientAccounts<'a> {}
